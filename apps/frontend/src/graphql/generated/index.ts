...
export type CreateContactMutation = { __typename?: 'Mutation', createContact: { __typename?: 'Contact', id: string, firstname: string, lastname: string, number: string } };
...
export type DeleteContactByIdMutation = { __typename?: 'Mutation', deleteContactById: { __typename?: 'Contact', id: string, firstname: string, lastname: string, number: string } };
...
export type UpdateContactByIdMutationMutation = { __typename?: 'Mutation', updateContactById: { __typename?: 'Contact', id: string, firstname: string, lastname: string, number: string } };

export type GetAllContactsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllContactsQuery = { __typename?: 'Query', getAllContacts: Array<{ __typename?: 'Contact', id: string, firstname: string, lastname: string, number: string }> };
...
export type GetContactByIdQuery = { __typename?: 'Query', getContactById: { __typename?: 'Contact', id: string, firstname: string, lastname: string, number: string } };
...
export type SearchByLastNameQuery = { __typename?: 'Query', searchByLastName: Array<{ __typename?: 'Contact', id: string, firstname: string, lastname: string, number: string }> };
...
export const useDeleteContactByIdMutation = <
    ...
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<DeleteContactByIdMutation, TError, DeleteContactByIdMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<DeleteContactByIdMutation, TError, DeleteContactByIdMutationVariables, TContext>(
      ['DeleteContactById'],
      (variables?: DeleteContactByIdMutationVariables) => fetcher<DeleteContactByIdMutation, DeleteContactByIdMutationVariables>(client, DeleteContactByIdDocument, variables, headers)(),
      options
    );
...
export const useUpdateContactByIdMutationMutation = <
    ...
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<UpdateContactByIdMutationMutation, TError, UpdateContactByIdMutationMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<UpdateContactByIdMutationMutation, TError, UpdateContactByIdMutationMutationVariables, TContext>(
      ['UpdateContactByIdMutation'],
      (variables?: UpdateContactByIdMutationMutationVariables) => fetcher<UpdateContactByIdMutationMutation, UpdateContactByIdMutationMutationVariables>(client, UpdateContactByIdMutationDocument, variables, headers)(),
      options
    );
...
export const useGetAllContactsQuery = <
    ...
    useQuery<GetAllContactsQuery, TError, TData>(
      variables === undefined ? ['GetAllContacts'] : ['GetAllContacts', variables],
      fetcher<GetAllContactsQuery, GetAllContactsQueryVariables>(client, GetAllContactsDocument, variables, headers),
      options
    );
...
export const useGetContactByIdQuery = <
    ...
    useQuery<GetContactByIdQuery, TError, TData>(
      ...
      fetcher<GetContactByIdQuery, GetContactByIdQueryVariables>(client, GetContactByIdDocument, variables, headers),
      options
    );
...
export const useSearchByLastNameQuery = <
    ...
    useQuery<SearchByLastNameQuery, TError, TData>(
      ...
      fetcher<SearchByLastNameQuery, SearchByLastNameQueryVariables>(client, SearchByLastNameDocument, variables, headers),
      options
    );